...
module soc_system_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> intr_capturer_0_avalon_slave_0_agent:cp_channel
	...
	wire  [128:0] sysid_qsys_control_slave_agent_rp_data;                                             // sysid_qsys_control_slave_agent:rp_data -> router_009:sink_data
	...
	wire  [128:0] dipsw_pio_s1_agent_rp_data;                                                         // dipsw_pio_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [128:0] button_pio_s1_agent_rp_data;                                                        // button_pio_s1_agent:rp_data -> router_011:sink_data
	...
	wire    [6:0] router_003_src_channel;                                                             // router_003:src_channel -> hps_0_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	...
	wire    [6:0] hps_0_h2f_lw_axi_master_wr_limiter_cmd_src_channel;                                 // hps_0_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> cmd_demux_003:sink_channel
	...
	wire    [6:0] rsp_mux_003_src_channel;                                                            // rsp_mux_003:src_channel -> hps_0_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	...
	wire    [6:0] router_004_src_channel;                                                             // router_004:src_channel -> hps_0_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	...
	wire    [6:0] hps_0_h2f_lw_axi_master_rd_limiter_cmd_src_channel;                                 // hps_0_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> cmd_demux_004:sink_channel
	...
	wire    [6:0] rsp_mux_004_src_channel;                                                            // rsp_mux_004:src_channel -> hps_0_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	...
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> jtag_uart_avalon_jtag_slave_burst_adapter:sink0_channel
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> avalon_leds_0_avs_s0_burst_adapter:sink0_channel
	...
	wire    [6:0] avalon_leds_0_avs_s0_burst_adapter_source0_channel;                                 // avalon_leds_0_avs_s0_burst_adapter:source0_channel -> avalon_leds_0_avs_s0_agent:cp_channel
	...
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sysid_qsys_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // sysid_qsys_control_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sysid_qsys_control_slave_burst_adapter:sink0_channel
	...
	wire    [6:0] sysid_qsys_control_slave_burst_adapter_source0_channel;                             // sysid_qsys_control_slave_burst_adapter:source0_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] dipsw_pio_s1_burst_adapter_source0_channel;                                         // dipsw_pio_s1_burst_adapter:source0_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] button_pio_s1_burst_adapter_source0_channel;                                        // button_pio_s1_burst_adapter:source0_channel -> button_pio_s1_agent:cp_channel
	...
	wire    [6:0] cmd_demux_003_src1_channel;                                                         // cmd_demux_003:src1_channel -> cmd_mux_003:sink1_channel
	...
	wire    [6:0] cmd_demux_003_src2_channel;                                                         // cmd_demux_003:src2_channel -> cmd_mux_004:sink1_channel
	...
	wire    [6:0] cmd_demux_003_src3_channel;                                                         // cmd_demux_003:src3_channel -> cmd_mux_005:sink1_channel
	...
	wire    [6:0] cmd_demux_003_src4_channel;                                                         // cmd_demux_003:src4_channel -> cmd_mux_006:sink1_channel
	...
	wire    [6:0] cmd_demux_004_src0_channel;                                                         // cmd_demux_004:src0_channel -> cmd_mux_001:sink2_channel
	...
	wire    [6:0] cmd_demux_004_src1_channel;                                                         // cmd_demux_004:src1_channel -> cmd_mux_003:sink2_channel
	...
	wire    [6:0] cmd_demux_004_src2_channel;                                                         // cmd_demux_004:src2_channel -> cmd_mux_004:sink2_channel
	...
	wire    [6:0] cmd_demux_004_src3_channel;                                                         // cmd_demux_004:src3_channel -> cmd_mux_005:sink2_channel
	...
	wire    [6:0] cmd_demux_004_src4_channel;                                                         // cmd_demux_004:src4_channel -> cmd_mux_006:sink2_channel
	...
	wire    [6:0] rsp_demux_001_src2_channel;                                                         // rsp_demux_001:src2_channel -> rsp_mux_004:sink0_channel
	...
	wire    [6:0] rsp_demux_003_src1_channel;                                                         // rsp_demux_003:src1_channel -> rsp_mux_003:sink1_channel
	...
	wire    [6:0] rsp_demux_003_src2_channel;                                                         // rsp_demux_003:src2_channel -> rsp_mux_004:sink1_channel
	...
	wire    [6:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> rsp_mux_003:sink2_channel
	...
	wire    [6:0] rsp_demux_004_src2_channel;                                                         // rsp_demux_004:src2_channel -> rsp_mux_004:sink2_channel
	...
	wire    [6:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_003:sink3_channel
	...
	wire    [6:0] rsp_demux_005_src2_channel;                                                         // rsp_demux_005:src2_channel -> rsp_mux_004:sink3_channel
	...
	wire    [6:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> rsp_mux_003:sink4_channel
	...
	wire    [6:0] rsp_demux_006_src2_channel;                                                         // rsp_demux_006:src2_channel -> rsp_mux_004:sink4_channel
	...
	wire    [6:0] hps_0_h2f_lw_axi_master_wr_limiter_cmd_valid_data;                                  // hps_0_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> cmd_demux_003:sink_valid
	wire    [6:0] hps_0_h2f_lw_axi_master_rd_limiter_cmd_valid_data;                                  // hps_0_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> cmd_demux_004:sink_valid
